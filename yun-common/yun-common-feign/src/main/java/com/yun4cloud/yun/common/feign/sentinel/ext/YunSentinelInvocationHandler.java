...
import com.yun4cloud.yun.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class YunSentinelInvocationHandler implements InvocationHandler {
	...
	YunSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			YunSentinelInvocationHandler other = (YunSentinelInvocationHandler) obj;
