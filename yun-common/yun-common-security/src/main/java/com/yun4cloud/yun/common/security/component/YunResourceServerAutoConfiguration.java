...
public class YunResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public YunBearerTokenExtractor yunBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new YunBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new YunCustomOpaqueTokenIntrospector(authorizationService);
	}
	...
	public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
		return new YunOAuthRequestInterceptor(tokenResolver);
	}
