package com.yun4cloud.yun.common.security.service;
 ...
 * @date 2021/12/21
 */
public interface YunUserDetailsService extends UserDetailsService, Ordered {
	...
	default UserDetails getUserDetails(R<UserInfo> result) {
		...
		// 构造security用户
		return new YunUser(user.getUserId(), user.getDeptId(), user.getUsername(),
	 ...
	 * @return
	 */
	default UserDetails loadUserByUser(YunUser yunUser) {
		return this.loadUserByUsername(yunUser.getUsername());
	}
